<template>
  <div class="centered-container md-layout md-gutter md-alignment-center">
    <Poll class="container md-layout-item md-medium-size-33 md-small-size-50 md-xsmall-size-100"/>
    <Vote class="container md-layout-item md-medium-size-33 md-small-size-50 md-xsmall-size-100"/>
    <Chart class="container md-layout-item md-medium-size-33 md-small-size-50 md-xsmall-size-100"/>
...
export default {
  name: 'App',
  components: { Poll, Chart, Vote },
  methods: {
    ...mapActions('poll', { loadPollData: 'load' })
  },
  mounted: function () {
    this.loadPollData()
  }
